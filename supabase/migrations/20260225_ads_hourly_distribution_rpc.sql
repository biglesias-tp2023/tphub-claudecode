...
BEGIN
  ...
  SELECT
    ...
    COALESCE(SUM(a.qty_impressions), 0)::BIGINT AS impressions,
    COALESCE(SUM(a.qty_clicks), 0)::BIGINT AS clicks,
    COALESCE(SUM(a.qty_orders_ad), 0)::BIGINT AS orders,
    COALESCE(SUM(a.amt_ad_revenue), 0)::NUMERIC AS ad_revenue
